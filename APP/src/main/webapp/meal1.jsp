...
<h3>WELCOME TO LUNCH,DEAR <%= user.name %></h3>
<h4><%=user.email %></h4>
</div>
<a href="viewLunch.jsp">VIEW ALL LUNCH DETAILS</a>
 		<br>
 		<br>

<h3 style="color:red;">LUNCH.</h3>
<img src="kid.gif" alt="Dance" width="600" height="300">
<div class="container">
  <div class="jumbotron">

<form action="addMeal1.jsp" method="post">

<div class="container">
  <div class="jumbotron">
<ol>
<div class="form-group">
 <li> <label for="usr">MEAL-2:</label></li>
